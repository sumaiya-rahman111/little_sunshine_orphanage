...
Route::middleware('auth')->group(function(){
    ...
    Route::get('/feedback',[Navz::class,'feedback'])->name('feedback');
    // table menu ends
    ...
    // frontend related routes starts here
    ...
    Route::post('/updateOrphan/{id}',[OrphanController::class,'update'])->name('updateOrphan');
        ...
        // get involve section starts
    Route::get('/partner',[InvolveClass::class,'partner'])->name('partner');
    Route::get('/volunteer',[InvolveClass::class,'volunteer'])->name('volunteer');
    Route::get('/sponsor',[InvolveClass::class,'sponsor'])->name('sponsor');
        // get involve section ends

    // frontend related routes ends here
