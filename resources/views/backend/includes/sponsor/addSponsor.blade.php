                ...
                <div class="col-12 mb-6 col-auto">
                    <div class="box">
                        <div class="box-body pb-20">
                                ...
                                <!-- form starts here -->
                                <form action="{{ Route('sponsorBackStore') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row mbn-15">
                                        ...
                                        <div class="form-group col-lg-6 col-md-12 mt-4">
                                            <label for="desc">NID:</label>
                                            <input name="nid" type="text" class="form-control info" placeholder="Enter NID Here..." required>
                                        </div>
                                        <div class="form-group col-lg-6 col-md-12 mt-4">
                                            <label for="p2">Company:</label>
                                            <input name="company" type="text" class="form-control info" placeholder="Enter Company Name...">
                                        </div>
                                        <div class="form-group col-lg-6 col-md-12 mt-4">
                                            <label for="p2">Trade Liscense Number:</label>
                                            <input name="tlNumber" type="text" class="form-control info" placeholder="Enter trade liscense number...">
                                        </div>
                                        <div class="form-group col-lg-6 col-md-12 mt-4">
                                            <label for="p2">Bank Name:</label>
                                            <input name="bank" type="text" class="form-control info" placeholder="Enter bank name..." required>
                                        </div>
                                        <div class="form-group col-lg-6 col-md-12 mt-4">
                                            <label for="p2">Branch Name:</label>
                                            <input name="branch" type="text" class="form-control info" placeholder="Enter branch name...">
                                        </div>
                                        <div class="form-group col-lg-6 col-md-12 mt-4">
                                            <label for="p2">Area Code:</label>
                                            <input name="area" type="text" class="form-control info" placeholder="Enter area code..." required>
                                        </div>
                                        <div class="form-group col-lg-6 col-md-12 mt-4">
                                            <label for="p2">Account Number:</label>
                                            <input name="account" type="text" class="form-control info" placeholder="Enter account number..." required>
                                        </div>
                                        <div class="form-group col-lg-6 col-md-12 mt-4">
