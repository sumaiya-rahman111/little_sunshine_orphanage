...
<div class="align-items-center mb-10">
    <div class="showDetails text-center">
        <div class="aboutPick">
        <h1 class="text-secondary h1 my-4">Sponsor Details</h1>
            ...
            <div class="detabout">
                ...
                <p>{{ $datas->email }}</p>
                <h4 class="mt-4 text-info">NID</h4>
                <p>{{ $datas->nid }}</p>
        ...
        <a href="{{ Route('sponsorRequest') }}" class="back button button-outline button-info text-center button-md mt-3">
