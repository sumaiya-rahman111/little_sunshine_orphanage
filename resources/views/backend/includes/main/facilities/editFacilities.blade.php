                ...
                <div class="col-12 mb-6 col-auto">
                    <div class="box">
                        <div class="box-body pb-20">
                                ...
                                <!-- form starts here -->
                                <form action="{{ route('updateFacilities',$datas->id) }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row mbn-15">
                                        <div class="form-group col-lg-12 col-md-12 mt-4">
                                            <label for="image">Image:</label>
                                            <img src="{{ asset('frontend') }}/images/facilities/{{ $datas->image }}" alt="{{ $datas->heading }}">
                                            <input name="image" type="file" class="form-control mt-3 info">
                                        </div>
                                        <div class="form-group col-lg-12 col-md-12 mt-4">
