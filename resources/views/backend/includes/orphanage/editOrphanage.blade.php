...
<div class="row justify-content-between align-items-center mb-10">
                ...
                <div class="col-12 col-lg-auto mb-20">
                    <div class="page-heading">
                        <h3>Edit Orphanage <span>( input original and authenticated information as much as possible! )</span></h3>
                    </div>
                ...
                <div class="col-12 mb-6 col-auto">
                    <div class="box">
                        <div class="box-body pb-20">
                                ...
                                <!-- form starts here -->
                                <form action="{{ Route('updateOrphanage',$datas->id) }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row mbn-15">
                                        <div class="form-group col-12 mt-20">
                                            <label for="photo">Enter Picture: (not more than 1.5 megabytes)</label>
                                            <img class="image mb-4" src="{{ asset('backend') }}/imageStore/orphanages/{{ $datas->photo }}" alt="{{$datas->name}}"/>
                                        ...
                                        <div class="form-group col-lg-4 col-md-6 mt-20">
                                            ...
                                            <input name="short_desc" type="text" class="form-control info" placeholder="Say something about the organization in short...." value="short_desc">
                                        </div>
                                        <div class="form-group col-lg-4 col-md-6 mt-20">
                                            <label for="desc">Full Description:</label>
                                            <input name="desc" type="text" class="form-control info" placeholder="Say something about the organization in short...." value="{{ $datas->desc }}">
                                        </div>
                                        <div class="form-group col-lg-4 col-md-6 mt-20">
                                        ...
                                        <div class="form-group col-lg-4 col-md-6 mt-20">
                                            ...
                                            <input name="email" type="text" class="form-control info" placeholder="Orphanage Email.." value="{{ $datas->email }}">
                                        </div>
                                    </div>
